...
public class CentrosDeAtencionVisualizacionCercaniaResultadoMapaStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "04_Se hace clic en el botón Buscar y validamos el contenido";
