...
public class CentrosDeAtencionCercaniaDeslogueoResultadosListaStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "05_Se desloguea al usuario";
			CurrentPage = (new CartillaMedicaPage().GetInstance(CartillaMedicaPage.class));
			CurrentPage.As(CartillaMedicaPage.class).click_deslogueo();
			CurrentPage.As(CartillaMedicaPage.class).aceptar_deslogueo();
			log.LogMobile.SuccessStep(nombrePaso);

			nombrePaso = "06_Se validan que el usuario se encuentre deslogueado en el inicio";
