...
public class ReintegrosPasoUnoMensajesErrorStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "03_Se verifican los mensajes error del paso 1 al no seleccionar nada";
			CurrentPage = (new ReintegrosPage().GetInstance(ReintegrosPage.class));
			CurrentPage.As(ReintegrosPage.class).click_continuar();
			assertTrue(CurrentPage.As(ReintegrosPage.class).verificaMsjesErrorPaso1());
			log.LogMobile.SuccessStep(nombrePaso);
