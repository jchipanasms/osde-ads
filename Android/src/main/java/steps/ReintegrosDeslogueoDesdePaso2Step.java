...
public class ReintegrosDeslogueoDesdePaso2Step extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "04_Se desloguea al usuario desde el paso 2 y verificamos que se encuentre en inicio";
			CurrentPage = (new GestionesOnlinePage().GetInstance(GestionesOnlinePage.class));
