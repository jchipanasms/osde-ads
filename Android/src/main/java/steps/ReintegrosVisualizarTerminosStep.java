...
public class ReintegrosVisualizarTerminosStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "03_Se realiza clic en terminos y condiciones";
			CurrentPage = (new ReintegrosPage().GetInstance(ReintegrosPage.class));
			CurrentPage.As(ReintegrosPage.class).click_terminos();
			assertTrue(CurrentPage.As(ReintegrosPage.class).visualizaTituloTerminos());
			log.LogMobile.SuccessStep(nombrePaso);
