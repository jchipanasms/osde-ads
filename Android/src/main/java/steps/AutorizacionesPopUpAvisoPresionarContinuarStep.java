...
public class AutorizacionesPopUpAvisoPresionarContinuarStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "07_Presionamos en Continuar y verificamos que nos encontremos en el paso 3";
