...
public class ReintegrosDeslogueoDesdePaso1Step extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "03_Se desloguea al usuario del paso 1 y verificamos que se encuentre en inicio";
