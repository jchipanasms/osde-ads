...
public class AutorizacionesVisualizarProteccionDeDatosPersonalesStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "05_Presionamos en el link de proteccion de datos personales, validamos y presionamos en cruz";
			CurrentPage.As(AutorizacionesPage.class).clic_proteccionDatos();
			Assert.assertTrue(CurrentPage.As(AutorizacionesPage.class).esVisibleProteccionDatos());
			CurrentPage.As(AutorizacionesPage.class).clic_cruz_proteccion();
			log.LogMobile.SuccessStep(nombrePaso);			
