...
public class AutorizacionesPresionarVolveDesdePaso4Step extends BaseStepMobile {
...
//			log.LogMobile.SuccessStep(nombrePaso);
			...
			nombrePaso = "07_Desde el paso 4 presionamos en volver";
			Assert.assertTrue(CurrentPage.As(AutorizacionesPage.class).autorizacionesDe("internación o cirugía"));
			...
			nombrePaso = "08_Validamos que nos encontremos en el paso 3";
