...
public class CartillaOsdeViajaConVosTimeOutDeslogueoNombreStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "03_Se ingresa a Buscar por nombre y validamos que se encuentre el popup de timeout luego de 30seg";
