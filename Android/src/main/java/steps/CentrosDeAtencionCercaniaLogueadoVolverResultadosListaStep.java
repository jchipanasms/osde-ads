...
public class CentrosDeAtencionCercaniaLogueadoVolverResultadosListaStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "06_Validamos que nos encontremos en la pantalla de resultados por mapa junto con el nombre de usuario, boton volver y deslogueo";
