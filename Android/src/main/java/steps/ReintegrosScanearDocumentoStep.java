...
public class ReintegrosScanearDocumentoStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			assertTrue(CurrentPage.As(ReintegrosPage.class).verificaTextoAdjuntar("Tamaño máximo 2MB. PDF o JPG"));
			...
			CurrentPage = (new ReintegrosPage().GetInstance(ReintegrosPage.class));
			assertTrue(CurrentPage.As(ReintegrosPage.class).verificaTextoAdjuntar("Factura.jpg"));
			log.LogMobile.SuccessStep(nombrePaso);	
