...
public class AutorizacionesPresionarVolverDesdePaso2Step extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "05_Desde el paso 2 presionamos en volver";
			CurrentPage = (new GestionesOnlinePage().GetInstance(GestionesOnlinePage.class));
			CurrentPage.As(GestionesOnlinePage.class).volver();
			log.LogMobile.SuccessStep(nombrePaso);
			
			nombrePaso = "06_Validamos que nos encontremos en el paso 1";
