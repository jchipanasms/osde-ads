...
public class CartillaOsdeViajaConVosNormasGeneralesCercaniaStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "03_Se ingresa a Buscar por cercanía y le damos clic a normas generales";
			CurrentPage.As(CartillaMedicaPage.class).clicSubMenuOsdeViajaConVos("buscar por cercania");
			CurrentPage.As(CartillaMedicaPage.class).clic_normas_desde("cercania");
			...
			CurrentPage.As(CartillaMedicaPage.class).seleccionPlan("310");
			assertTrue(CurrentPage.As(CartillaMedicaPage.class).elTituloEsPlan("310"));
