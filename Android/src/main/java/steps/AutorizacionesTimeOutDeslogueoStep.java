...
public class AutorizacionesTimeOutDeslogueoStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "04_Esperamos 30seg. hasta que aparezca el popup timeout y validamos el mismo";
			try {
				Thread.sleep(30000);
			} catch (Exception e) {
			...
			nombrePaso = "05_Verificamos que nos encontremos en inicio luego de esperar otros 30seg. hasta que desaparezca el popup";
			try {
				Thread.sleep(30000);
			} catch (Exception e) {
				// TODO: handle exception
