...
public class CentrosDeAtencionVisualizacionCercaniaResultadoListaStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "05_Se hace clic en el listado de Resultados y validamos el contenido de la pagina";
