...
public class CartillaOsdeViajaConVosNormasGeneralesNombreStep extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "03_Se ingresa a Buscar por nombre y le damos clic a normas generales";
			CurrentPage.As(CartillaMedicaPage.class).clicSubMenuOsdeViajaConVos("buscar por nombre");
			CurrentPage.As(CartillaMedicaPage.class).clic_normas_desde("nombre");
			...
			assertTrue(CurrentPage.As(CartillaMedicaPage.class).elTituloEsPlan("510"));
