...
public class ReintegrosVolverDesdePaso2Step extends BaseStepMobile {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "04_Se vuelve desde el paso 2 al 1 y verificamos que se encuentre en el mismo";
			CurrentPage = (new GestionesOnlinePage().GetInstance(GestionesOnlinePage.class));
