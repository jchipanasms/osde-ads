...
public class CentrosDeAtencionProvinciaPage extends BasePageMobile {
...
//	@FindBy (xpath = "//*[resource-id='']")
	@FindBy (id = "capBusqPorProvinciaLocalidadButton")
	...
	@FindBy (id = "centro-atencion-telefonica")
	...
	public void clickComboProvincia() {
		try {
			waitFluent.until(ExpectedConditions.elementToBeClickable(ComboProvincia));
	...
	public void clickProvinciaCABA() {
		try {
			waitFluent.until(ExpectedConditions.elementToBeClickable(ProvinciaBsAs));
			ProvinciaBsAs.click();
			LogMobile.info("Se hizo click en el botón de provincia");
		} catch (Exception e) {
			LogMobile.info("Fallo el hacer click en el botón de Provincia");
	...
	public void clickComboLocalidad() {
		try {
			waitFluent.until(ExpectedConditions.elementToBeClickable(ComboLocalidad));
